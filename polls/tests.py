...
def create_question(text, days):
    ...
    question = Question.objects.create(text=text, date_published=time)
    return question
...
class QuestionIndexViewTests(TestCase):
    ...
    def test_past_question(self):
        """
        Questions with a date_published in the past are displayed
        on the index page.
        """
...
class QuestionDetailViewTests(TestCase):
    def test_future_question(self):
        """
        The details view of a question with a date_published in the future
    ...
    def test_past_question(self):
        """
        The details view of a question with a date_published in the past
...
class QuestionModelTests(TestCase):
    def test_was_published_recently_with_future_date(self):
        ...
        whose date_published is in the future.
        """
    ...
    def test_was_published_recently_with_old_question(self):
        """
        was_published_recently() returns False for a question whose
    ...
    def test_was_published_recently_with_recent_question(self):
        """
        was_published_recently() returns True for questions whose date_published
        is within the last day.
        """
        time = timezone.now() - datetime.timedelta(hours=23, minutes=59, seconds=59)
        recent_question = Question(date_published=time)

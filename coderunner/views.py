...
def main(request):
    return render(request, 'coderunner/main.html')
...
def account(request):
    ...
    return render(request, 'coderunner/account.html', {'acSubmissions':acSubmissions,
                                            'numSolves':numSolves})
...
def submissions(request):
    ...
    return render(request, 'coderunner/submissions.html', {'submissions':submissions})
...
def allProblems(request):
    ...
    return render(request, 'coderunner/problems.html', {'problems':problems, 'count':count,
...
def problemDetail(request, name):
    ...
    return render(request, "coderunner/problem.html", {'problem':problem, 'sourceDict':sourceDict})
